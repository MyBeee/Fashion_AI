...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            isValid = _a.sent();
                            if (isValid) {
                                return [2 /*return*/, { message: '로그인 성공!' }];
                            }
                            else {
                                return [2 /*return*/, { error: '이메일 또는 비밀번호가 잘못되었습니다.' }];
                            }
                            return [2 /*return*/];
                    }
                });
        ...
        AuthController_1.prototype.signup = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.createUser(body.name, body.email, body.password)];
                });
            });
        };
