...
var user_entity_1 = require("../entities/user.entity"); // ✅ User 엔티티 명시적 등록
            ...
            imports: [
                ...
                typeorm_1.TypeOrmModule.forRootAsync({
                    ...
                    useFactory: function (configService) { return ({
                        ...
                        password: configService.get('DB_PASSWORD', '5584'),
                        database: configService.get('DB_NAME', 'nest_project'),
                        entities: [user_entity_1.User], // ✅ 엔티티 명시적으로 등록
